...
public class Assignment_01_Hotel_Trivago {
	...
	public static void scrapeData(String url, String csvFileName) {
		...
		try {
			...
			for (WebElement hotelTrivagoElement : hotelTrivagoElements) {
				...
				csvWriter.append("\"").append(hotelTrivagoName).append("\",\"").append(hotelTrivagoPrice).append("\"\n");
